...
update_env_settings() {
  ...
  update_env_var "RELAYHOST_USERNAME" "${RELAYHOST_USERNAME:-}"
  update_env_var "RELAYHOST_PASSWORD" "${RELAYHOST_PASSWORD:-}"
  update_env_var "RELAYHOST_TLS_LEVEL" "${RELAYHOST_TLS_LEVEL:-}"
